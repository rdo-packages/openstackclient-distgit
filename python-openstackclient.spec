...
Requires:         python-openstacksdk >= 0.9.16
...
Requires:         python-%{sclient}-lang = %{version}-%{release}
...
%package  -n python-%{sclient}-lang
Summary:   Translation files for Openstackclient

%description -n python-%{sclient}-lang
...
%files -n python-%{sclient}-lang -f openstackclient.lang
%license LICENSE
